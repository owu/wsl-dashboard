...
- ഈ സോഫ്റ്റ്‌വെയർ Microsoft Store വഴി വിതരണം ചെയ്യുന്നില്ല.
- ഇവിടെ അതേ പേരിലുള്ള ആപ്പുകൾ അനധികൃത പൈറേറ്റഡ് സോഫ്റ്റ്‌വെയർ ആണ്.
- തട്ടിപ്പിൽ നിന്ന് രക്ഷപ്പെടാൻ ദയവായി ഡൗൺലോഡ് ചെയ്യരുത്.
```
