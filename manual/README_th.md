...
- ซอฟต์แวร์นี้ไม่ได้แจกจ่ายผ่าน Microsoft Store
- แอปพลิเคชันใดๆ ที่มีชื่อเดียวกันที่ปรากฏบนนั้นเป็นซอฟต์แวร์ละเมิดลิขสิทธิ์ที่ไม่ได้รับอนุญาต
- โปรดอย่าดาวน์โหลดเพื่อหลีกเลี่ยงการถูกหลอกลวง
```
